...
CodonMuSel implements the SK model for jointly infering the impact on **Codon** bias of **Mu**tation and **Sel**ection acting on nucleotide cost and tranlsational efficiency. The SK model was first described in:
